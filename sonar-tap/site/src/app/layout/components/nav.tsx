          ...
          >
            <SidebarMenuButton
              ...
              className={cn(
                ...
                isActive
                  ? "bg-primary/15 text-[var(--sidebar-nav-active)] rounded-lg border-l-4 border-[var(--sidebar-nav-active)] hover:bg-primary/15 hover:text-[var(--sidebar-nav-active)] group-data-[collapsible=icon]:bg-transparent group-data-[collapsible=icon]:border-0 group-data-[collapsible=icon]:hover:bg-sidebar-accent/70"
