// apis/pushgateway/metrics/v1/metrics.thrift
namespace go pushgateway.metrics.v1
...
struct StorageStats {
    ...
    6: required string min_time_date;     // 
    7: required string max_time_date;     // 
    8: required i64 min_time;     // 
    9: required i64 max_time;     // 
}
