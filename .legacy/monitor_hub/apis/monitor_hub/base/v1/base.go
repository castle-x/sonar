...
const (
	...
	// 资源已存在
	BaseErrorCode_RESOURCE_ALREADY_EXISTS BaseErrorCode = 1010
)
...
func (p BaseErrorCode) String() string {
	...
	case BaseErrorCode_RESOURCE_ALREADY_EXISTS:
...
func BaseErrorCodeFromString(s string) (BaseErrorCode, error) {
	...
	case "RESOURCE_ALREADY_EXISTS":
		return BaseErrorCode_RESOURCE_ALREADY_EXISTS, nil
	}
...
type Page struct {
	...
	// 当前页码
	Page int64 `thrift:"page,2" json:"page,omitempty" form:"page" query:"page"`
	// 每页大小
	PageSize int64 `thrift:"page_size,3" json:"page_size,omitempty" form:"page_size" query:"page_size"`
	// 总页数
	TotalPage int64 `thrift:"total_page,4" json:"total_page,omitempty" form:"total_page" query:"total_page"`
	// 当前页实际数量
	Num int64 `thrift:"num,5" json:"num,omitempty" form:"num" query:"num"`
	// 查询条件 (可选)
